...
public class DBAmountFormAdapter {
    ...
    public void deleteAmountForm(String id){
        database.delete(DatabaseConstantInformation.AMOUNTFORMTABLE,DatabaseConstantInformation.ID_AMOUNTFORM +"=?", new String[]{id});
    }
}
